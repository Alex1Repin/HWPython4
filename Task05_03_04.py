...
with open('polinomial1.txt', 'a', encoding='utf-8') as data1:
    data1.write('23x⁹ - 16x⁸ + 3x⁷ + 15x⁴ - 2x³ + x² + 20 = 0')

with open('polinomial2.txt', 'a', encoding='utf-8') as data2:
    data2.write('17x⁹ + 15x⁸ - 8x⁷ + 15x⁶ - 10x⁴ + 7x³ - 13x + 33 = 0')

# with open('polinomial1.txt', 'r') as data1:
#     pol1 = data1.readline()


# with open('polinomial2.txt', 'r') as data2:
#     pol2 = data2.readline()

file1 = 'polynomial1.txt'
file2 = 'polynomial2.txt'
file_sum = 'Sum_polynomials.txt'
# Почему он не видит файлы?
